...
function menu() {
  ...
  var NavTogglers = Nav.querySelectorAll('.js-nav-toggler');
  ...
  function toggleMenu(clickedButton) {
    clickedButton.addEventListener('click', function () {
      ...
      if (clickedButton.classList.contains(toggledClass)) {
        NavTogglers.forEach(function (button) {
          return button.classList.remove(toggledClass);
        });
      } else {
        NavTogglers.forEach(function (button) {
          return button.classList.remove(toggledClass);
...
init();
},{"./menu":"src/js/menu.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/js/scripts.js"], null)
//# sourceMappingURL=/scripts.f66c610d.js.map